---
title: "Beyond Polygon Bloat: Stylized Real-Time Shading Architecture for Japanese Street Realism (Morado / Genshin / Zelda Paradigm)"
google_doc_id: "1j-yGucSOJefWUvdz31hjcztJmBl3ln2NisuPqf_YtSw"
google_doc_url: "https://docs.google.com/document/d/1j-yGucSOJefWUvdz31hjcztJmBl3ln2NisuPqf_YtSw/edit"
exported_from: "Google Docs API (fifaworldcup2026 / google.documents scope)"
canonical_role: "Technical manifesto on real-time stylized shading, Half-Lambert wraps, Morado proxy textures, and overcoming polygon bloat."
---

# Beyond Polygon Bloat: Stylized Real-Time Shading Architecture for Japanese Street Realism (Morado / Genshin / Zelda Paradigm)
> **Live Google Doc**: [1j-yGucSOJefWUvdz31hjcztJmBl3ln2NisuPqf_YtSw](https://docs.google.com/document/d/1j-yGucSOJefWUvdz31hjcztJmBl3ln2NisuPqf_YtSw/edit)  
> **Archive Purpose**: Technical manifesto on real-time stylized shading, Half-Lambert wraps, Morado proxy textures, and overcoming polygon bloat.
...
## [2026-09-03 UPDATE] Object 02 (Timber Facade & Lattice Doors) Finalized & Verified

- **Detailed Documentation**: https://docs.google.com/document/d/1ry754XIZOmjj1J0Cdpn7y3oHOBq5RvVGto4BRTfb-88/edit
- **Key Methodological Milestones**:
  1. **Sub-Snapshot Decomposition**: Split ground floor threshold (no awning) and second floor wall (no roof) from independent 3D objects (awning `Obj 03`, kawara roof).
  2. **Architectural Proportions Corrected**: Second floor updated to **4 wide horizontal timber sash window bays** (`引き違い横長窓`, Width > Height $\approx 1.35$) fully contained without cutoffs, with dark yakisugi scorched cedar fascia board running along the top edge directly meeting the roof junction.
  3. **Dual Reference Streams**: Both **2D Illustrative (Washi)** and **Photorealistic-ish (Multi-View Documentary)** reference archives fully integrated into Kyojima Eki Studio.
  4. **Corner Landmark Integration**: Finalized Object 01 (Crimson Vending Machine) unskewed and plumb at $X = 2.45\text{m}, Z = 2.65\text{m}$.
  5. **3D Solid Geometry**: Zero see-through angles, solid pitched roof with 16 rafters, double-sided cantilevered awning.
- **Export Staging**: Mirrored to `/Volumes/T9/makingpancakes/finalized-assets/kyojima-eki/object-02-timber-facade/` and `object-03-sun-awning/`.
